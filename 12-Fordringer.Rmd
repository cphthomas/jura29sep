...
Det kræves desuden, at erklæringen er dispositiv, hvilket indebærer, at der efter almindelige regler skal foreligge et løfte. 
...
Dette krav fraviges, hvor det er sædvanligt, at dokumentet ikke underskrives, fx ved rente- og udbyttekuponer. 
...
Kravet om, at erklæringen skal være ensidig, indebærer at fx en købekontrakt ikke er et gældsbrev: 
...
Hvis flere landes møntenhed, har samme betegnelse, fx kroner, men gældsbrevet ved sin angivelse af skyldens størrelse ikke har bestemt, hvilket lands mønt, der er tænkt på, antages det, at der skal betales i betalingsstedets mønt, jf. dommen i **U 1962.294 H**.
...
Selvom der i så fald formelt foreligger en overdragelsessituation, kan der reelt være tale om en udstedelsessituation, så D ikke mister eventuelle indsigelser over for K2.

---

<h4><a href="https://www.youtube.com/embed/8ufuecp-wXA" target="_blank">Video Hvordan udarbejder du et gældsbrev</a></h4>
...
<h4><a href="https://www.youtube.com/embed/PPqd-fYRCg0" target="_blank">Video Hvordan du udarbejder en låneaftale</a></h4>
...
"BL § 100, stk. 5"),
  S3 = c("Hændelse",
      ...
      den pinkode er brugt. Kunden har som minimum har handlet simpelt uagtsomt. ",
...
<h4><a href="https://www.youtube.com/embed/uODiLMSn3kg" target="_blank">Video 2 Videre om gældsbrevsloven</a></h4>

---

<h4><a href="https://www.youtube.com/embed/nC3Sy7tBCaY" target="_blank">Video 3 Mere om gældsbrevsloven</a></h4>
...
Udlægshavere skal derfor ikke foretage nogen særlig sikringsakt i forhold til andre kreditorer. Se RPL § 526, stk. 1 og 2.  
...
For at udlægshavere kan blive legitimeret over for gældsbrevsdebitor, skal han derfor have gældsbrevet i hænde og for de tinglyste digitale pantebreves vedkommende have tinglyst sin ret. 
...
Det er typen af aktiv, der er afgørende for hvilken sikringsakt, der skal foretages. Hvis der fx er tale om udlæg i livsforsikringspoler, skal der ske påtegning på policen.
...
**"Vindikation"** er tilbagesøgning af ting, som en anden uretmæssig besidder - fx udlevering til ejermanden af en stjålen cykel. Kan ske, selv om besidderen har købt tingen i god tro.
...
**Følgende indsigelser over for kreditor bevares:**
...
Er der fx aftalt **"skadesløs transport"**, hæfter overdrageren som simpel kautionist over for erhververen for fordringen.
...
Grundlæggende er formålet med reglerne om overdragelse af simple fordringer at undgå, at skyldnerens byrde øges ved overdragelse. 
...
Opdager skyldneren fx efter betaling, at skyldneren kan gøre misligholdelsesbeføjelser gældende i anledning af kontraktsforholdet med overdrageren, kan sådanne misligholdelsesbeføjelser ikke som et pengekrav rettes mod erhververen efter GBL § 27.
...
**HR:** Først i tid bedst i ret (uskreven hovedregel i dansk ret).
...
## Udlæg i et simple gældsbrev eller den simple fordring 
...
+	Den gode tro er til stede på det tidspunkt gældsbrevet bliver overdraget fysisk.
...
Det kan fx tænkes, at gældsbrevet er blevet stjålet fra ejeren og forsynet med en falsk transportpåtegning, hvorefter det er bragt i omsætning.  
...
I almindelighed kan det forlanges, at erhververen undersøger selve gældsbrevet. 

Den, der vil bestride erhververens ret, må bevise, at erhververen ikke har udvist den nødvendige agtpågivenhed.  
...
Desuden er simple pantebreve dels tinglyste digitale pantebreve,  
...
Når erhverver har foretaget sin sikringsakt (tinglysning), kan skyldner betale med frigørende virkning til den nu tinglyste erhverver, så gælden nedskrives eller forsvinder.
...
+	Den gode tro er til stede på det tidspunktet hvor erhverver får tinglyst sin ret, jf. nærmere TL § 5.
...
- Reglerne, bortset fra § 31, finder tillige anvendelse på tinglyste digitale simple gældsbreve, jf. GBL § 26, stk. 2.
...
- Der kan på intet tidspunkt være tinglyst både virksomhedspant og fordringspant, jf. TL § 47e, stk. 2. 
...
- Det kaldes et trepartsforhold, når købet finansieres af tredjemand, dog ikke når køberen selv skaffer sig kreditten (fx ved lån i egen bank).
...
- Har Kreditgiveren fået pant i fast ejendom gælder reglerne i KAL § 33, stk. 2-4 kun i det omfang, andet ikke følger af reglerne om tinglyste pantebreve i fast ejendom - jf. KAL § 33 stk. 5.
...
- Overdrageren indestår for fordringens beståen, (fx at denne er ugyldig eller betalt) - GBL § 9.
...
2.	Fordringerne skal være udjævnelige (komputabilitet). Dvs., at ydelsen efter den ene fordring umiddelbart kan anvendes til opfyldelse af hovedfordringen (fx penge mod penge, men ikke pære mod æbler). 
