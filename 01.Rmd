...
Af de mere end 1.300 love, vi har i Danmark, er der én lov, en retskilde, der er hævet over alle de andre, nemlig grundloven.  ``r tippy(indeks[1,1], size="large" ,interactive = TRUE, arrow = TRUE, tooltip = paste0("<h4>",indeks[1,2],"</h4>"))`` er Danmarks forfatning, dvs. den lov, der beskriver de grundlæggende regler for samfundet, se grundloven i lovsamlingen i kapitel 26: **https://jura.tepedu.dk/lovsamling.html**.
...
**Video: Grundlovsændringen i 1915: Historien om de 7 F'er**
...
**Video: Dit Demokrati | Hvem må stemme?**
...
**Video: Dit Demokrati | Finansloven**
...
**Video:Dit Demokrati | Fra idé til lov**
...
**Video: En film om gadevold - retsspil**
...
**Video: Rettens arbejde - Vidnets rolle i en straffesag ved byretten**
