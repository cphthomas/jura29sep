...
```{r kaution, echo=FALSE, message=FALSE,fig.height=5}
...
```{r, echo=FALSE, result=TRUE, message=FALSE,fig.height=5,fig.cap=("Omstødelsesperiode for gaver")}
library(timevis)
...
```{r, echo=FALSE, result=TRUE, message=FALSE ,fig.height=3,fig.cap=("Modregning før fristdag")}
library(timevis)
...
```{r, echo=FALSE, result=TRUE, message=FALSE ,fig.height=3,fig.cap=("Modregning mellem fristdag og konkursdekret")}
library(timevis)
...
```{r, echo=FALSE, result=TRUE , message=FALSE,fig.height=4,fig.cap=("Modregning mellem fristdag og konkursdekret")}
library(timevis)
